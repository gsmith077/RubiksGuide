...
![Solving the Cube Cover]({0792DF7C-F09F-48E7-97CB-D502B0E8AA0F}.png)
...
![alt text]({E54FF10F-0486-43C7-9366-6D17323639F9}.png)
...
![Valid First Side Solved]({1E46FD6B-6434-48B1-948B-76EBFA7EAA2B}.png)

I later consolidated the steps by only solving the corners:

![Corners only on Face 1]({12D079B9-F39A-424D-BD89-60DAE8FBB6EC}.png)
...
![Before algorithm]({53E6B080-D4A5-4517-B99E-6F0F313318D2}.png)
...
![Finishing corner alignment]({195D672C-CFD4-450A-BD3B-B10935863D4F}.png)
...
![Solving Edges, maintaining the channel]({F0E832FB-4909-4ABE-A657-8F574E8FCA5C}.png)
...
![Little Hill Case]({A13BA92E-5BFF-495F-AA95-D7021658DD89}.png)
...
![Big Hill Case]({4986CFAB-148B-4263-A535-9A91FEC8C1BF}.png)

## CONGRADULATTONS!!! YOU HAVE DONE THE CUBE

![Congradulations]({DAAE444E-9B7B-43D2-AE39-90EE066AA094}.png)
...
![Example Scramble]({F7A44FCD-8F17-4369-BDD6-E023FAFACC78}.png)
